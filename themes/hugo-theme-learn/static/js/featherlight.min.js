    ...
    if (u.fn.jquery.match(/-ajax/))
      ...
      ((c.prototype = {
        ...
        setup: function (e, t) {
          ...
          return (
            (n.$instance = i.clone().addClass(n.variant)),
        ...
        getContent: function () {
          ...
          var t = this,
            ...
            o = e[t.type];
          if (
            (!o && i in e && ((o = e[i]), (i = t.target && r)),
            (i = i || n("href") || ""),
            !o)
          )
            for (var a in e) t[a] && ((o = e[a]), (i = t[a]));
          if (!o) {
            var s = i;
            if (
              ((i = null),
        ...
        resize: function (e, t) {
          if (
            ...
            this.$content.parent().width() < e ||
              this.$content.parent().height() < t)
          ) {
            var n = Math.max(
          ...
          attach: function (i, o, a) {
            ...
            var c,
              ...
              t = function (e) {
                ...
                ("shared" === r.persist
                  ? (c = r)
                  : !1 !== r.persist && t.data("featherlight-persisted", r),
                  n.$currentTarget.blur && n.$currentTarget.blur(),
                  r.open(e));
              };
            return (
              i.on(l.openTrigger + "." + l.namespace, l.filter, t),
          ...
          _callbackChain: {
            ...
            afterClose: function (e, t) {
              ...
              return (
                ...
                0 === c.opened().length &&
                  u(document.documentElement).removeClass("with-featherlight"),
                n
              );
            },
